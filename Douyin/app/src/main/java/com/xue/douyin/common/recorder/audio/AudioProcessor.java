 ...
 * <p>
 * Call {@link #configure(int, int)} to configure the processor to receive input audio, then
...
public interface AudioProcessor {
     ...
     */
    boolean configure(int sampleRateHz, int channelCount);
     ...
     * as a result of calling {@link #configure(int, int)} and is undefined if the instance is
     * not active.
     */
     ...
     * result of calling {@link #configure(int, int)} and is undefined if the instance is not
     * active.
     */
