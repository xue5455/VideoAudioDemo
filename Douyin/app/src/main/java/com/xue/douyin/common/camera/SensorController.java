...
public class SensorController implements SensorEventListener {
    ...
    private SensorController() {
        mSensorManager = (SensorManager) AppProfile.getContext().getSystemService(Activity.SENSOR_SERVICE);
    ...
    public void register(CameraFocusListener mCameraFocusListener) {
        if (mSensorManager == null) {
            return;
        }
        restParams();
