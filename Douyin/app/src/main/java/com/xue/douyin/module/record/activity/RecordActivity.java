...
import com.xue.douyin.common.codec.AudioConfig;
import com.xue.douyin.common.codec.AudioEncoder;
import com.xue.douyin.common.codec.MovieMuxCore;
import com.xue.douyin.common.codec.VideoRecorder;
...
import com.xue.douyin.common.codec.VideoConfig;
import com.xue.douyin.common.codec.VideoEncoder;
...
public class RecordActivity extends BaseBlankActivity<RecordPresenter> implements OnSurfaceCreatedCallback,
    ...
    public void onSurfaceCreated(final SurfaceTexture texture, EGLContext context) {
        try {
            mRecorder = new VideoRecorder(new VideoConfig(context, 720, 1280, 1000000), new AudioConfig(), 5);
            mRecorder.setOnMaxLengthListener(new MovieMuxCore.OnVideoMaxLengthListener() {
                @Override
    ...
    public void onFrameAvailable(VideoFrameData frameData) {
        if (mRecorder != null) {
            mRecorder.videoNewFrame(frameData);
        }
    }
}
